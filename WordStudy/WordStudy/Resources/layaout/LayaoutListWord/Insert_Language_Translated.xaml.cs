...
namespace WordStudy.Resources.layaout.LayaoutListWord
{
    ...
    public partial class Insert_Language_Translated : ContentPage
    {
        public Insert_Language_Translated()
        {
            InitializeComponent();
        }
        ...
        private async void ListLanguage(object sender, ItemTappedEventArgs e)
        {
            ...
            language_Choice_Db1.Language_Translated_Choice = Lang;

            //language_Choice_Db1.Language_Translated_Choice = T_lang;

            App.Database_Lang_C.input_Lang_onli(language_Choice_Db1);
